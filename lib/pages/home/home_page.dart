          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  HomeMenuButton(iconMenu: Icon(Icons.punch_clock_sharp), text: 'Hour',),
                  HomeMenuButton(iconMenu: Icon(Icons.sunny), text: 'Day',),
                  HomeMenuButton(iconMenu: Icon(Icons.calendar_month), text: 'Long-Term',),
                ],
              ),
              SizedBox(height: 20,),
              Row(
